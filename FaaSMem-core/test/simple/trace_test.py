...
def test_to_all():
    ...
    target_functions = {
        ...
        'graph_bfs': {'configs': {'raw_memory': 885, 'cpu': 0.5, 'exec_duration': 0.3}, 'tests': [
            ...
            {'test_id': '2-debug', 'configs': {'system': 'FaaSMem'}},
        ...
        'bert': {'configs': {'raw_memory': 1770, 'cpu': 1, 'exec_duration': 0.15}, 'tests': [
            # {'test_id': '2-ablation', 'configs': {'system': 'FaaSMem'}},
            # {'test_id': '2-ablation', 'configs': {'system': 'FaaSMem', 'MGLRU': False}},
            # {'test_id': '2-ablation', 'configs': {'system': 'FaaSMem', 'semiwarm': False}},
            # {'test_id': '2-ablation', 'configs': {'system': 'baseline'}},
