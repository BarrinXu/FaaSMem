...
def analysis_for_semiwarm_offload_simulation():
    ...
    for k, v in res.items():
        print(k, len(v))
    with open('../result/semiwarm_offload_simulation/semiwarm_offload_simulation_result.json', 'w') as f:
        json.dump(res, f)
...
def analysis_for_container_lifetime_cdf():
    ...
    with open('../result/container_lifetime_cdf/container_lifetime_cdf.json', 'w') as f:
        json.dump(res, f)
